...
export class SvgTextureFactory {
  static preloadAll(scene) {
    ...
    scene.load.svg('enemy_drifter', 'assets/svg/enemies/drifter.svg', { width: R(14), height: R(14) });
    ...
    scene.load.svg('enemy_mini_boss', 'assets/svg/enemies/mini_boss.svg', { width: R(96), height: R(36) });
