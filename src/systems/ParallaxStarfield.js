export class ParallaxStarfield {
  constructor(scene) {
    ...
    this.layers = [
      { count: 150, speed: 20, size: 1, alpha: 0.35, color: 0xffffff },
      { count: 70, speed: 60, size: 2, alpha: 0.6, color: 0xffffff },
      { count: 30, speed: 140, size: 3, alpha: 0.85, color: 0xffd9aa }
    ];
